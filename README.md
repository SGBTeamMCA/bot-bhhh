...
## How to install (DEFAULT or BASIC USAGE)
	* git clone https://github.com/SGBTeamMCA/bot-bhhh.git
	* cd bot-igeh
...
## For PC/Laptop ONLY:
	...
	* Download File on Github (https://github.com/SGBTeamMCA/bot-bhhh.git)
	* Extract File bot-bhhh and enter the folder
